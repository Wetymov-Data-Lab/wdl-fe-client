  ...
  adapters: {
    ...
    column: {
      fromServer: (dto: CoreApi.Column): Schema.TableColumn => ({
        ...
        scale: dto.scale,
        arrayDimensions: dto.array_dimensions,
        nullable: dto.nullable,
        primaryKey: dto.primary_key,
        unique: dto.unique,
        autoIncrement: dto.auto_increment,
      ...
      toUpdateServer: (value: Schema.UpdateColumnInput): CoreApi.UpdateColumn => ({
        name: value.name,
        type: value.type,
        ...
        scale: value.scale,
        array_dimensions: value.arrayDimensions,
        nullable: value.nullable,
        primary_key: value.primaryKey,
        unique: value.unique,
        auto_increment: value.autoIncrement,
